...
export const experiences = [
  ...
  
  {
    ...
    company: "AKTU (R.V. Institute of Technolog)" ,
...
export const education = [
  ...
  },
  {
    ...
    grade: "84%",
    desc: "Successfully completed 12th grade with an outstanding 84% grade in the PCM (Physics, Chemistry, Mathematics) stream from UP board at A.V.N Inter College, Kiratpur. Exhibited proficiency in complex scientific and mathematical concepts while maintaining a strong academic record. Demonstrated disciplined study habits and a commitment to academic excellence, laying a robust groundwork for future educational and career aspirations.",
    degree: "UP BOARD (X) ",
  },
  {
    id: 2,
    ...
    grade: "78%",
    desc: "Successfully completed 10th grade with a commendable 78% grade from UP board at A.V.N Inter College, Kiratpur. Demonstrated strong academic performance and dedication to excellence in studies. Developed foundational skills in various subjects, setting a solid platform for future academic and professional pursuits.",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      ...
      "https://github.com/assistant0307",
    tags:["javascript"," html5","css"],
    category: "web app",
    github: "https://github.com/assistant0307",
    webapp: "https://github.com/assistant0307.com/",
  },
  {
    id: 0,
    title: "Music player",
    ...
    description:
      "The music player is a software project supporting all known media filesand has the ability to play them with ease . uses may attach folder to play add various media files within it. Usermay see track lists and play desired ones accordingly",
    image:
      "https://github.com/assistant0307/",
    tags: ["javascript"," html5","css"],
    category: "web app",
  ...
  
  {
    ...
    image:
      "https://github.com/assistant0307/Ecommerce-website/blob/main/Screenshot%20(20).png?raw=true",
    tags: ["javascript"," html5","css"],
    category: "web app",
    github: "https://github.com/assistant0307",
